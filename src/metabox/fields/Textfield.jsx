...
function Textfield({ label, value, onChange, placeholder, required, error }) {
  return (
    <div className="mb-4">
      ...
      <input
        type="text"
        className={`mt-1 block w-full border rounded-md shadow-sm focus:ring focus:ring-opacity-50 px-3 py-2 text-base ${error ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-400'}`}
