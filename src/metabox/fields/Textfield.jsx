...
const Textfield = memo(({ label, value, onChange, placeholder, required, error, fieldId }) => {
  ...
  return (
    <div className="mb-4 ccc-field" data-field-id={fieldId}>
      ...
      <input
        type="text"
        className={`mt-2 block w-full border rounded-md !shadow-sm focus:ring focus:ring-opacity-50 px-3 py-2 text-base cursor-text h-10 ${error ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-400'}`}
