...
const ComponentEditNameModal = ({ isOpen, component, onClose, onSave }) => {
  ...
  const handleSubmit = async () => {
    ...
    formData.append("handle", handle || generateHandle(name)) // Allow handle to be updated if changed
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setName(value)
                // Only auto-update handle if it hasn't been manually changed from its initial auto-generated value
          ...
          <div>
            ...
            <input
              ...
              disabled={true} // Keep disabled for now, as per previous logic
            />
